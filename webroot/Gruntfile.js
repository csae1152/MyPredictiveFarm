...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    watch: {
      ...
      files: ["build/less/*.less", "build/less/skins/*.less", "dist/js/mypredictive_app.js"],
      tasks: ["less"]
    },
    ...
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/skins/default.skin.scss"
        }
      },
      ...
      production: {
        ...
        files: {
          ...
          "dist/css/skins/_all-skins.min.css": "build/less/skins/_isoagrobus.less"
        }
      }
    },
